...
// V2Validator wraps go-playground/validator with SPIFFE-specific custom validators.
type V2Validator struct {
	validator *validator.Validate
}

// NewV2Validator creates a new validation instance with custom SPIFFE validators.
func NewV2Validator() *V2Validator {
...
func (v *V2Validator) Validate(s interface{}) error {
	return v.validator.Struct(s)
}

// ValidateVar validates a single variable using the specified tag.
func (v *V2Validator) ValidateVar(field interface{}, tag string) error {
...
// ValidationErrorV2 wraps go-playground validator errors with additional context.
...
func (ve *ValidationErrorV2) Error() string {
...
func ConvertValidationErrors(err error) []ValidationErrorV2 {
	var errors []ValidationErrorV2

	if validationErrors, ok := err.(validator.ValidationErrors); ok {
		for _, validationErr := range validationErrors {
			errors = append(errors, ValidationErrorV2{
...
// Global V2 validator instance for convenience.
var GlobalV2Validator = NewV2Validator()

// ValidateStructV2 is a convenience function using the global V2 validator.
func ValidateStructV2(s interface{}) error {
	return GlobalV2Validator.Validate(s)
}